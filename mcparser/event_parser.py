"""
1. update Item's Chinese name if cn server has different name from the previous translated
2. update Event's **Extra** part manually for hunting/lottery/Barbatos
...
class EventParser:
    ...
    def _parse_limit_event(self, key: str) -> MapEntry[str, LimitEvent]:
        ...
        if '狩猎' in event.name:
            ...
            hunting_data = {
                ...
                7: [(1, '凶骨', 16.0), (2, '八连双晶', 35.0), (3, '凤凰羽毛', 40.2), (4, '闲古铃', 54.8),
                    (4, '宵泣之铁桩', 36.0), (5, '战马的幼角', 66.9), (5, '永远结冰', 57.6), (6, '智慧之圣甲虫像', 113.2),
                    (6, '枯淡勾玉', 56.8)],
                8: [("All", '追忆的贝壳', 90), (1, '龙之牙', 16.3), (2, '振荡火药', 17.6), (3, '光银之冠', 47.7), (3, '蛇之宝玉', 49.4),
                    (4, '血之泪石', 66.7), (4, '英雄之证', 23.7), (5, '精灵根', 94.8), (5, '凤凰羽毛', 57.1),
                    (6, '真理之卵', 100.0), (6, '愚者之锁', 29.8)],
                9: [("All", '闲古铃', 88), (1, '愚者之锁', 16.5), (2, '大骑士勋章', 33.9), (3, '极光之钢', 47.1), (3, '八连双晶', 46.3),
                    (4, '晓光炉心', 58.3), (4, '无间齿轮', 37.5), (5, '蛮神心脏', 93.7), (5, '魔术髓液', 29.6),
                    (6, '奇奇神酒', 97.2), (6, '陨蹄铁', 47.3)]
            }
        ...
        elif '影之国的舞斗会' in event.name:
            event.extra = {
                '咒兽胆石': '第1期传说级: 157.7 AP', '永远结冰': '第1期传说级: 148.8 AP', '世界树之种': '第1期传说级: 118.6 AP',
                '九十九镜': '第2期传说级: 157.3 AP', '虚影之尘': '第2期传说级: 64.2 AP',
                '蛮神心脏': '第3期传说级: 162.7 AP', '宵泣之铁桩': '第3期传说级: 53.9 AP',
